...
El objetivo de este estudio es identificar los factores que influyen en la mejora del rendimiento académico de los estudiantes. Para lograrlo, se han utilizado técnicas de aprendizaje automático que permiten analizar grandes volúmenes de datos y extraer patrones que pueden ser utilizados para la toma de decisiones en el ámbito educativo.
...
Excluimos 'Exam_Score' y 'Previous_Scores' ya que 'Improved' es derivada de ellas.
...
Para manejar el desbalance del entrenamiento, aplicamos submuestreo de la clase mayoritaria con 'downSample':
...
-   Accuracy (Precisión): El modelo tiene una precisión del 92%.

-   Sensitivity (Sensibilidad): El 95.97% de los estudiantes que mejoraron fueron correctamente identificados.

-   Specificity (Especificidad): El 90.09% de los estudiantes que no mejoraron fueron correctamente identificados.

-   Kappa: Valor de 0.8251, indicando un alto nivel de acuerdo más allá del azar.

El modelo muestra un buen desempeño en términos de precisión y equilibrio entre sensibilidad y especificidad, lo cual es importante dado el desbalance original de clases.
...
Una vez validado el modelo, vamos a determinar cuales son las variables mas importantes que influyen en la predicción de la mejora del estudiante.
...
======= 31b8e172-b470-440e-83d8-e6b185028602::31b8e172-b470-440e-83d8-e6b185028602
...
🔍 ¿Para qué sirve este código y la animación generada?

El objetivo principal de este código es visualizar el proceso de clasificación de los estudiantes en el árbol de decisión, permitiendo ver cómo la asistencia, el involucramiento parental y las horas de estudio influyen en la predicción de si un estudiante mejorará o no.

📌 Lo que representa la animación: • Cada punto representa un estudiante. • El eje X muestra el porcentaje de asistencia. • El eje Y representa las horas de estudio por semana. • El color indica la etapa del árbol en la que se encuentra cada estudiante. • El tipo de marcador (círculo o triángulo) indica si el estudiante mejoró o no.

📌 Cómo funciona la animación: • La animación recorre las diferentes etapas del árbol de decisión, mostrando cómo los estudiantes son clasificados progresivamente según sus características. • En cada etapa, el gráfico se enfoca en los estudiantes que cumplen con los criterios de división del árbol.

📊 ¿Qué información útil podemos extraer?

1️⃣ Importancia de la asistencia: • La primera división del árbol ocurre en Attendance \< 79.5%, lo que indica que la asistencia es un factor clave en la mejora del rendimiento. • Los estudiantes con baja asistencia (rojo) parecen menos propensos a mejorar.

2️⃣ Involucramiento parental y horas de estudio: • La segunda y tercera división se basan en Parental_Involvement \< 2.5 y Hours_Studied \< 29.5, lo que sugiere que la combinación de apoyo familiar y tiempo de estudio es crucial.

3️⃣ Predicción visual del desempeño: • Se observa una concentración de estudiantes que no mejoraron (círculos) en ciertas etapas tempranas del árbol, mientras que en otras se encuentran más estudiantes que sí mejoraron (triángulos). • En etapas finales, se pueden identificar subconjuntos donde la mejora es más probable, lo que sugiere estrategias de intervención.

🚀 Conclusión

Esta animación permite visualizar de manera intuitiva cómo el modelo de árbol de decisión clasifica a los estudiantes en función de variables clave. También ayuda a identificar patrones, como: ✅ Factores críticos para la mejora (asistencia, apoyo parental, horas de estudio). ✅ Áreas de intervención (grupos de estudiantes que podrían beneficiarse de tutorías o estrategias de motivación). ✅ Diferencias entre los estudiantes que mejoran y los que no, lo que puede ayudar a proponer soluciones personalizadas.
...
# 1️⃣ Añadir un identificador único para cada estudiante
#Hecho Antes en el GIFT Animado

# 2️⃣ Convertir 'Improved' en una variable categórica con etiquetas
#Hecho Antes en el GIFT Animado
...
# 4️⃣ Definir colores para cada etapa y formas para 'Improved'
#Hecho Antes en el GIFT Animado

# 5️⃣ Crear el gráfico interactivo con ggplot2
